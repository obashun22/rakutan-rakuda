        ...
        <div className="column is-3 px-5 py-4 info">
          ...
          <div className="class-info">
            ...
            <p className="property">
              <a onClick={() => props.onClick(post.category)}>
                {post.category}
              </a>
              ／{post.year} {post.term}
            </p>
          ...
          <div className="review-info mt-4">
            <p className="evaluation">
              授業評価: <span className="review">{post.evaluation}</span>
            </p>
            <p className="cause">
              落単理由: <span className="review">{post.cause}</span>
            </p>
          </div>
        </div>
        ...
        <div className="column px-5 py-4 card-right">
          ...
          <div className="action">
            <div className="kusa pt-1">
              {isLiked ? (
                <img src={kusa} alt="kusa" className="kusa-img kusa-anim" />
              ) : (
                <img
                  src={kusaWhite}
                  alt="kusa white"
