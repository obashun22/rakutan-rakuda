...
const Title = (props) => {
  // formの入力に必要な情報を初期化
  const categorieOptions = ["「大学での学び」基礎論", "基礎セミナー", "英語", "初修外国語", "日本語", "健康・スポーツ科学科目（講義）", "健康・スポーツ科学科目（実習）", "データ科学科目", "国際理解科目", "現代教養科目", "超学部セミナー", "人文・社会系基礎科目", "自然系基礎科目", "全学教養科目", "文系教養科目", "理系教養科目", "文系基礎科目", "理系基礎科目", "理系基礎（文系）", "理系基礎（理系）", "言語文化I", "言語文化II", "言語文化III", "基礎セミナー", "健康・スポーツ科学", "開放科目", "専門科目", "文学部専門科目", "教育学部専門科目", "法学部専門科目", "経済学部専門科目", "情報学部専門科目", "情報文化学部専門科目", "理学部専門科目", "医学部専門科目", "工学部専門科目", "農学部専門科目", "G30", "大学院", "不明", "その他"];
  const yearOptions = [];
  // 最新の年度を先頭にする
  let date = new Date();
